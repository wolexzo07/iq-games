...
function sendmail_local($to,$subject,$message){
  ...
  $mail->IsSMTP();
  $mail->SMTPAuth   = true;
  $mail->Host       = "iqgames.app";
  $mail->Port       = 587;
  $mail->Username   = "support@iqgames.app";
  $mail->Password   = "Affinity1990?";
  $mail->SMTPSecure = 'tls';
  $mail->SetFrom("support@iqgames.app", "Iqgames.app");
  $mail->AddReplyTo("support@iqgames.app","Iqgames.app");
...
$mail = new PHPMailer\PHPMailer\PHPMailer();
$mail->isSendmail();
$mail->setFrom('no-reply@iqgames.app', 'iqgames.app');
$mail->addReplyTo('support@iqgames.app', 'iqgames.app');
$mail->addAddress($to, '');
$mail->Subject = $subject;
