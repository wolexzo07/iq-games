...
$query="select id from alertus WHERE status='1' order by id desc";
}
...
$query="SELECT * FROM alertus WHERE status='1' ORDER BY id desc
limit ".mysqli_real_escape_string(x_cstring(),$start).",$recordsPerPage";
}
...
<font style="color:purple;"><i style="font-size:30pt;" class="fa fa-check-circle"></i></font>
	<style>
	#msg<?php echo $id;?>{
	margin:5pt;
	display:none;
...
$msg .= "<p class='text-center'>No treated alert recieved!</p>";
			echo $msg;
