...
<h3 style="text-align:center;border:1px dashed green;padding:15px;margin-bottom:10pt;">DICE <font class="colorg">PREDICTION</font></h3>
...
<p class="let">Dice A prediction</p>
<input maxlength="8" required type="number" placeholder="Predict dice A" class="form-control ttx" name="first"/>
<p class="let">Dice B prediction</p>
